...
global.email = "kynexor.technologies@gmail.com";
...
global.github = process.env.GITHUB || "https://github.com/kynexor-technologies/KynexorTech-AI";
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://files.catbox.moe/g0urip.mp4";
global.devs = "27643779064";
global.sudo = process.env.SUDO || "27643779064";
...
global.scan = "https://kynexortech-session.onrender.com/";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "*This has been generated by Kynexor. <powered by KynexorTechnologies>*",
  author: process.env.PACK_AUTHER || "Cadillac Cylee 💭🖤",
  packname: process.env.PACK_NAME || "Kynexor 💭🖤",
  botname: process.env.BOT_NAME || "*KynexorTech-AI*",
  ...
  LANG: (process.env.THEME || "Kynexor").toUpperCase(),
};
global.rank = "updated";
